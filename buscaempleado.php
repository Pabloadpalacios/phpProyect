<body bgcolor="291d1c">
<legend><font color="white">Buscar empleado para liquidar</font></legend><br>
<form action="buscaempleado.php" method="GET">
...
$sql="SELECT * FROM empleados WHERE nombre_apellido LIKE '%$nombre_apellido%' ORDER BY nombre_apellido";
	...
	<table bgcolor="3561f3" border="3">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                  <a href="liquidar.php?legajo=<?php echo $filas['legajo']?>">Liquidar legajo</a>
              </td>
          </tr>
          <br>          
          <?php }?>
