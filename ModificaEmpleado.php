<body bgcolor="291d1c">
<legend><font color="white">Buscar empleado para modificar</font></legend><br>
<form action="ModificaEmpleado.php" method="GET">
	...
	<table bgcolor="3561f3" border="3">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                  <a href="ModificaEmpleado1.php?legajo=<?php echo $filas['legajo']?>">Modifica empleado</a>
              </td>
          </tr>
          <br>          
          <?php }?>
